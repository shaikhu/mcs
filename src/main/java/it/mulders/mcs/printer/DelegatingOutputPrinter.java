...
public class DelegatingOutputPrinter implements OutputPrinter {
    ...
    public DelegatingOutputPrinter(
        ...
        this.coordinateOutput = isCopyToClipboardEnabled(copyToClipboard)
                ? new ClipboardCoordinatePrinter((CoordinatePrinter) coordinateOutput)
                : coordinateOutput;
    }
    ...
    private boolean isCopyToClipboardEnabled(boolean copyToClipboard) {
        return copyToClipboard || "true".equals(System.getProperty("clipboard.copy", "false"));
    }
}
